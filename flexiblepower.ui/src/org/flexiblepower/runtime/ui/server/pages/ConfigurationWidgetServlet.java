...
public class ConfigurationWidgetServlet extends HttpServlet {
    private static final long serialVersionUID = -2367978642451243228L;
    private static final Logger logger = LoggerFactory.getLogger(ConfigurationWidgetServlet.class);

    private final WidgetRegistration registration;
    private final long expirationTime;

    public ConfigurationWidgetServlet(WidgetRegistration registration, long expirationTime) {
